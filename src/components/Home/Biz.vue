            ...
            <div class="static-container">
                <div class="std">
                    ...
                    <p>
                        ...
                        <a href="https://www.pissukanna.com/" target="_blank" title="Visit Magento's website" class="disguised-link">Check him out</a>.
                    </p>
                </div>
            </div>
            <div class="container">
                ...
                <div id="zen" aria-labelledby="zenDesc" width="25" height="25">
                    ...
                    <img :src="require('../../assets/hey.png')"  width="600" height="600"/>
                    <g class="zen-zen">
                        <g class="zen-legs">
