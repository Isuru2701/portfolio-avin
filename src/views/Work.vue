            ...
            <div class="std">
                ...
                <ul class="work-list">
                    <li>
                        ...
                        >
                            <img
                                src="@/assets/work/work-confianca.png"
                                alt="A smartphone showing the home page for the Confiança Delivery project"
                            />
                            <div class="details">
                                <strong>Confiança Delivery</strong><br />
                                <span class="-comment"
                                    >// 2018 - BizCommerce</span
                                ><br />
                    ...
                    <li>
                        <router-link to="/work/admin-panel" title="Admin Panel">
                            <img
                                src="@/assets/work/work-admin-panel.png"
                            ...
                            <div class="details">
                                ...
                                <span class="-comment"
                                    >// 2018 - BizCommerce</span
                                ><br />
                                A deep redesign of Magento's v1 admin panel for
                                BizCommerce
                            </div>
                        </router-link>
                    </li>
