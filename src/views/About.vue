        ...
        <div class="static-container">
            ...
            <div class="std">
                <div class="first-fold">
                    ...
                    <p class="-purple">
                        I am a creative frontend developer, designer and
                        illustrator.
                        <!--From Brazil, based in Barcelona - Catalunya - Spain.-->
                    </p>
                    <p class="-gray">
                        // 10+ years of experience<br />
                        <!--// Co-founder of Biz Commerce-->
                    </p>
                </div>
                ...
                <div class="about-grid">
                    ...
                    <div class="columns experience">
                        <ul>
                            <li>
                                <b class="-purple">Head of Product Design</b
                                ><br />
                                at BizCommerce<br />
                                2016 - 2019
                            </li>
                            ...
                            <li>
                                <b class="-purple">Head of Design & Frontend</b
                                ><br />
                                at JOE<br />
                                2010 - 2014
                            </li>
                            <li>
                                <b class="-purple">Senior Frontend Developer</b
                                ><br />
                                at Tray<br />
                                2008 - 2010
                            </li>
