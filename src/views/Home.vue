<template>
    <div id="home" class="wrapper">
        ...
        <Titles :viewport="viewport" scene="curriculum">
            ...
            <div class="std">
                <p class="-gray">&lt;find out more below&gt;</p>
            </div>
        </Titles>
...
export default {
    ...
    mounted() {
        ...
        // Pissu kanna's Marketing manager.
        this.sceneBizTitle()
        this.sceneBizZen()
    ...
    methods: {
        ...
        hookLoops() {
            ...
            this.scenes[12].on('enter', (e) => {
                // add bg just in case in both directions
                document.body.classList.add('-mario-bg')
            })
            this.scenes[13].on('enter', (e) => {
                // add bg just in case in both directions
                document.body.classList.add('-mario-bg')
            })
            this.scenes[14].on('enter', (e) => {
                // add bg just in case in both directions
                document.body.classList.add('-mario-bg')
            })
            this.scenes[15]
        ...
        sceneGhibli() {
            ...
            if (this.viewport.is568)
                castleLength =
                    '-' +
                    (window.innerWidth +
                        document.querySelector('.castle-container')
                            .offsetWidth +
                        16) +
                    'px'
